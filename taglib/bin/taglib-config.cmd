...
:doit
if /i "%1#" == "--libs#"    echo -LC:/Libraries/taglib/lib -llibtag
if /i "%1#" == "--cflags#"  echo -IC:/Libraries/taglib/include -IC:/Libraries/taglib/include/taglib
if /i "%1#" == "--version#" echo 1.12
if /i "%1#" == "--prefix#"  echo C:/Libraries/taglib
