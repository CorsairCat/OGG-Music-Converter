...
local MFD_IND_TEX_PATH        = LockOn_Options.script_path .. "../Textures/"  --定义屏幕贴图路径
local mp3_symbol_material     = MakeMaterial(MFD_IND_TEX_PATH.."mp3_symbol.tga", {152,195,100,255})
local mp3_symbol_white_material     = MakeMaterial(MFD_IND_TEX_PATH.."mp3_symbol.tga", {255,255,255,255})
